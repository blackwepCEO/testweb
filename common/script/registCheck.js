...
function IsValidID(UserID)
{
	...
	{
		if (tmptxt.length < 6 || tmptxt.length > 12 )
		{
...
function IsValidNickname(UserNICKNAME)
{
	...
	for(var i=0;i < tmptxt.length; i++)
	{
		...
		if(ch == "~" || ch == "`" || ch == "!" || ch == "@" || ch == "#" ||
		   ...
		   ch == "}" || ch == "[" || ch == "]" || ch == ":" || ch == ";" ||
		   ch == "<" || ch == ">" || ch == "," || ch == "." || ch == "?" || 
		   ch == "ㄱ" || ch == "ㄴ" || ch == "ㄷ" || ch == "ㄹ" || ch == "ㅁ" || ch == "ㅂ" || ch == "ㅅ" || ch == "ㅇ" || ch == "ㅈ" || ch == "ㅊ" || ch == "ㅋ" || ch == "ㅌ" || ch == "ㅍ" || ch == "ㅎ" || 
		   ch == "/" || ch == "\\" || ch == "|" || ch == "'" || ch == "\"")
		{
           return false; 
		}
	...
	if (UserNICKNAME.length < 4 || UserNICKNAME.length > 6 )
	{
		return false; 
	} else {
		return true;
